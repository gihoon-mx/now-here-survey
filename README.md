...
문항은 **설문**에 붙고, 참가자와 응답은 **세션**에 붙습니다. 같은 문항으로
오전·오후 여러 차례 진행하면서 결과를 회차별로 나눠 받을 수 있습니다.
참가자는 배정된 세션에만 들어갑니다.
